...
num_traits = 4; % we want to generalize to more dimensions
...
%     drawnow
    ...
    %traits_array = zeros(num_competitors,num_epochs,num_traits);
...
%% save structs
save('evolution_test_sm_results.mat', 'results');

%% visualize data
PlotResults_RPFSM('evolution_test_sm_results.mat');
